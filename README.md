...
> **Fiber** is an [Express](https://github.com/expressjs/express) ⭐ 68,889 | 🐛 210 | 🌐 JavaScript | 📅 2026-04-02 inspired **web framework** built on top of [Fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,309 | 🐛 108 | 🌐 Go | 📅 2026-04-04, the **fastest** HTTP engine for [Go](https://golang.org/doc/). Designed to **ease** things up for **fast** development with **zero memory allocation** and **performance** in mind.
...
* [Adaptor](https://github.com/gofiber/fiber/tree/main/middleware/adaptor) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Converter for net/http handlers to/from Fiber request handlers.
* [BasicAuth](https://github.com/gofiber/fiber/tree/main/middleware/basicauth) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Basic auth middleware provides an HTTP basic authentication. It calls the next handler for valid credentials and 401 Unauthorized for missing or invalid credentials.
* [Cache](https://github.com/gofiber/fiber/tree/main/middleware/cache) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Intercept and cache responses.
* [Compress](https://github.com/gofiber/fiber/tree/main/middleware/compress) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Compression middleware for Fiber, it supports `deflate`, `gzip` and `brotli` by default.
* [CORS](https://github.com/gofiber/fiber/tree/main/middleware/cors) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Enable cross-origin resource sharing (CORS) with various options.
* [CSRF](https://github.com/gofiber/fiber/tree/main/middleware/csrf) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Protect from CSRF exploits.
* [Earlydata](https://github.com/gofiber/fiber/tree/main/middleware/earlydata) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Early data support for Fiber.
* [Encrypt Cookie](https://github.com/gofiber/fiber/tree/main/middleware/encryptcookie) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Encrypt middleware which encrypts cookie values.
* [EnvVar](https://github.com/gofiber/fiber/tree/main/middleware/envvar) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Expose environment variables with providing an optional config.
* [ETag](https://github.com/gofiber/fiber/tree/main/middleware/etag) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Lets caches be more efficient and save bandwidth, as a web server does not need to resend a full response if the content has not changed.
* [Expvar](https://github.com/gofiber/fiber/tree/main/middleware/expvar) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Serves runtime exposed variants in JSON format via its HTTP server.
* [Favicon](https://github.com/gofiber/fiber/tree/main/middleware/favicon) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Ignore favicon from logs or serve from memory if a file path is provided.
* [Healthcheck](https://github.com/gofiber/fiber/tree/main/middleware/healthcheck) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Adds health-check endpoints for readiness and liveness probes.
* [Helmet](https://github.com/gofiber/fiber/tree/main/middleware/helmet) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Helps secure your apps by setting various HTTP headers.
* [Idempotency](https://github.com/gofiber/fiber/tree/main/middleware/idempotency) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Enables fault-tolerant APIs when duplicate requests occur.
* [Keyauth](https://github.com/gofiber/fiber/tree/main/middleware/keyauth) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Key auth middleware provides a key based authentication.
* [Limiter](https://github.com/gofiber/fiber/tree/main/middleware/limiter) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Rate-limiting middleware. Use to limit repeated requests to public APIs and/or endpoints such as password reset.
* [Logger](https://github.com/gofiber/fiber/tree/main/middleware/logger) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - HTTP request/response logger.
* [Pprof](https://github.com/gofiber/fiber/tree/main/middleware/pprof) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Serves runtime profiling data in the format expected by the pprof visualization tool.
* [Proxy](https://github.com/gofiber/fiber/tree/main/middleware/proxy) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Allows you to proxy requests to a multiple servers.
* [Recover](https://github.com/gofiber/fiber/tree/main/middleware/recover) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Recovers from panics anywhere in the stack chain and hands control to the centralized ErrorHandler.
* [Redirect](https://github.com/gofiber/fiber/tree/main/middleware/redirect) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Handles HTTP redirects in Fiber.
* [RequestID](https://github.com/gofiber/fiber/tree/main/middleware/requestid) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Adds a requestid to every request.
* [Responsetime](https://github.com/gofiber/fiber/tree/main/middleware/responsetime) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Adds an `X-Response-Time` header to responses.
* [Rewrite](https://github.com/gofiber/fiber/tree/main/middleware/rewrite) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Rewrites the URL path based on provided rules for backward compatibility or cleaner links.
* [Session](https://github.com/gofiber/fiber/tree/main/middleware/session) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Provides session management. NOTE: This middleware uses our Storage package.
* [Skip](https://github.com/gofiber/fiber/tree/main/middleware/skip) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Skips a wrapped handler when a predicate is true.
* [Static](https://github.com/gofiber/fiber/tree/main/middleware/static) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Serves static files from a local or custom file system.
* [Timeout](https://github.com/gofiber/fiber/tree/main/middleware/timeout) ⭐ 39,515 | 🐛 45 | 🌐 Go | 📅 2026-04-04 - Adds a max time for a request and forwards to ErrorHandler if it is exceeded.

### 🔗 External

List of externally hosted middleware modules and maintained by the [Fiber team](https://github.com/orgs/gofiber/people).

* [storage](https://github.com/gofiber/storage) ⭐ 325 | 🐛 24 | 🌐 Go | 📅 2026-04-03 - Premade storage drivers that implement the Storage interface, designed to be used with various Fiber middlewares.
* [template](https://github.com/gofiber/template) ⭐ 312 | 🐛 23 | 🌐 Go | 📅 2026-04-01 - This package contains 8 template engines that can be used with Fiber v1.10.x Go version 1.13 or higher is required.
...
* [oaswrap/fiberopenapi](https://github.com/oaswrap/spec/tree/main/adapter/fiberopenapi) ⭐ 94 | 🐛 2 | 🌐 Go | 📅 2026-04-05 - Fiber adapter for OpenAPI 3.x specification generation with automatic route documentation.
...
* [deepmap/oapi-codegen](https://github.com/deepmap/oapi-codegen) ⭐ 8,209 | 🐛 536 | 🌐 Go | 📅 2026-04-04 - Generate Go client and server boilerplate from OpenAPI 3 specifications.
